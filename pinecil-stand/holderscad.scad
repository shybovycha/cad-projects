...
module stand()
{
    union()
    {
        ...
        // legs
        translate([ 0, (64) / 2 + (8 / 2) - 0.1 + 6 + 15, -(65 - (10 / 2)) - 1 ])
            difference()
            {
        ...
        // translate([ 0, -8/2 + 5 + 5, -64 + (8 / 2) + 6 + 0.5 ])
            // rotate([ 0, -90, 0 ])
                // interior_fillet(l=8, r=10, ang=90, $fn=200);
            
        // translate([ 0, -35 / 2 - 5 - 4, -64 + (8 / 2) + (10 / 2) - 1 ])
            // cuboid([ 8, 35, 10 ], chamfer=3, edges=[FRONT+TOP]);
            
        translate([ 0, -35 / 2 - 5 - 4 + 17, -64 + (8 / 2) + (12) - 0.5 ])
            cyl(h=15, r1=30, r2=12, rounding1=-5, shift=[ 0, 10 ], $fn=200);
        ...
        difference()
        {
            union()
            {
                translate([ 0, (64) / 2 + (8 / 2) - 0.1 + 6 + 15, -(65 - (10 / 2)) - 1 - 2.5 ])
                ...
                translate([ 0, -64/2 - 4, -(65 - (10 / 2)) - 1 + 2.5 ])
                    rotate([ -90, 0, 0 ])
                        prismoid(size1=[64, 10], size2=[(64 + (8 * 2) - 2), 10], h=64 + 8 + 15);
            }
